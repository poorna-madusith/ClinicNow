...
export default function DoctorFullView({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-3xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden animate-slide-up"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header with Gradient Background */}
        <div className="relative p-8 bg-gradient-to-br from-teal-500 via-cyan-500 to-blue-500 overflow-hidden">
          {/* Decorative circles */}
          ...
          <div className="relative flex items-start justify-between">
            <div className="flex items-center gap-6">
              ...
              <div className="relative">
                ...
                <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-xl ring-4 ring-white/20">
                  {doctor.profileImageUrl ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-teal-100 to-cyan-100 text-5xl font-bold text-teal-700">
                      {doctor.firstName?.[0]}
                      {doctor.lastName?.[0]}
                    </div>
                  )}
            ...
            <button
              onClick={onClose}
              className="relative z-10 p-2.5 text-white/80 hover:text-white hover:bg-white/20 rounded-full transition-all duration-200 hover:rotate-90 hover:scale-110"
            >
              <svg
                className="w-6 h-6"
                fill="none"
        ...
        {/* Body */}
        <div className="p-8 overflow-y-auto bg-gradient-to-b from-gray-50/50 to-white">
          {/* About Section */}
          {doctor.docDescription && (
            <div className="mb-8 group">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-teal-500 to-cyan-500 shadow-md">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold text-gray-800 ml-3">About</h3>
              </div>
          ...
          <div className="mb-8">
            <div className="flex items-center mb-4">
              <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-500 shadow-md">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-800 ml-3">Details</h3>
            </div>
