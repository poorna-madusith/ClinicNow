        ...
        <>
                    ...
                    <div className="modal-header">
                        <div className="header-content">
                            ...
                            <div>
                                ...
                                <p className="modal-subtitle">Complete information about this session</p>
                            </div>
                        </div>
                    ...
                    <div className="modal-body">
                        ...
                        <div className="info-card doctor-card">
                            ...
                            <div className="card-content">
                                <p className="doctor-name">{session.doctor?.firstName} {session.doctor?.lastName}</p>
                        ...
                        <div className="details-grid">
                            <div className="detail-item">
                                ...
                                <div className="detail-content">
                                    ...
                                    <p className="detail-value">{new Date(session.date).toLocaleDateString('en-US', { 
                                        weekday: 'long', 
                                        year: 'numeric', 
                                        month: 'long', 
                                        day: 'numeric' 
                            ...
                            <div className="detail-item">
                                ...
                                <div className="detail-content">
                                    ...
                                    <p className="detail-value">{new Date(`1970-01-01T${session.startTime}`).toLocaleTimeString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true })} - {new Date(`1970-01-01T${session.endTime}`).toLocaleTimeString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true })}</p>
                                </div>
                            </div>
                            ...
                            <div className="detail-item">
                                ...
                                <div className="detail-content">
                                    ...
                                    <p className="detail-value fee-value">${session.sessionFee}</p>
                                </div>
                            </div>
                            ...
                            <div className="detail-item">
                                ...
                                <div className="detail-content">
                                    ...
                                    <span className={`status-badge ${session.canceled ? 'canceled' : 'active'}`}>
                        ...
                        <div className="info-card capacity-card">
                            ...
                            <div className="card-content">
                                <div className="capacity-stats">
                                    ...
                                    <div className="stat-divider"></div>
                                    <div className="stat-item">
                                        <p className={`stat-number ${availableSlots === 0 ? 'full' : ''}`}>{availableSlots}</p>
                                ...
                                <p className="capacity-percentage">{fillPercentage.toFixed(0)}% Full</p>
                            </div>
                        </div>
            ...
            <style jsx>{`
                ...
                .stat-divider {
                    width: 2px;
                    height: 40px;
                    background: linear-gradient(180deg, transparent 0%, #99f6e4 50%, transparent 100%);
                }
