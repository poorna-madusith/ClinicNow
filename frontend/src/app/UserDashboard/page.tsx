        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex-shrink-0">
              {(search.trim() !== "" || selectSpecialization !== "All") && (
                <button
                  onClick={() => {
                    setSearch("");
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
                {filteredDoctors.map((doctor: Doctor) => (
                  <div
                    key={doctor.id}
                    className="relative pt-20 sm:pt-24 group"
                  >
                    ...
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-10">
                      <div className="relative">
                        ...
                        <div className="relative w-32 h-32 sm:w-40 sm:h-40 rounded-full overflow-hidden border-4 border-white shadow-xl group-hover:shadow-2xl transition-all duration-300">
                        ...
                        {/* Gender badge */}
                        <div className="absolute bottom-1 right-1 sm:bottom-2 sm:right-2 bg-white px-2 py-1 sm:px-3 sm:py-1.5 rounded-full shadow-lg border-2 border-teal-100">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 hover:border-teal-200 flex flex-col overflow-hidden">
                      {/* Doctor Information */}
                      <div className="pt-16 sm:pt-20 pb-4 sm:pb-6 px-4 sm:px-6 flex-grow flex flex-col">
                        ...
                        <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6 text-center">
                          {doctor.town && (
                            <div className="flex items-center justify-center text-xs sm:text-sm bg-gray-50 py-2 px-3 sm:px-4 rounded-lg">
                              <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-teal-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        {/* Actions */}
                        <div className="border-t border-gray-100 pt-3 sm:pt-5 mt-auto">
                          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-2 sm:mb-3">
                            <button
                              onClick={() => handleViewMore(doctor)}
                              className="flex-1 flex items-center justify-center text-xs sm:text-sm text-teal-600 hover:text-white border-2 border-teal-500 hover:bg-teal-500 font-semibold py-2 sm:py-2.5 px-3 sm:px-4 rounded-lg transition-all duration-300"
                            >
                              <svg
                                className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-1.5 flex-shrink-0"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                            ...
                            <button onClick={()=> handleBookingClick(doctor.id)} className="flex-1 bg-gradient-to-r from-teal-500 to-cyan-600 text-white font-semibold py-2 sm:py-2.5 px-3 sm:px-4 rounded-lg hover:from-teal-600 hover:to-cyan-700 transition-all duration-300 shadow-md hover:shadow-lg text-xs sm:text-sm transform hover:scale-105">
                              Book Now
                            </button>
                          </div>
                          <button
                            onClick={() => handleFeedbackClick(doctor)}
                            className="w-full flex items-center justify-center text-xs sm:text-sm text-amber-600 hover:text-white border-2 border-amber-500 hover:bg-amber-500 font-semibold py-2 sm:py-2.5 px-3 sm:px-4 rounded-lg transition-all duration-300"
                          >
                            <svg
                              className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-1.5 flex-shrink-0"
                              fill="none"
